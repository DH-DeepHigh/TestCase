    ...
    GovernanceModule
{
    ...
    address public immutable MODULE_INITIALIZE; // 초기화 모듈
    /// @notice Address of the Token module
    address public immutable MODULE_TOKEN; // 토큰 전송 등 처리하는 모듈
    /// @notice Address of the Vault module
    address public immutable MODULE_VAULT; // vault관련 기능 모듈
    /// @notice Address of the Borrowing module
    address public immutable MODULE_BORROWING; // 대출 모듈
    /// @notice Address of the Liquidation module
    address public immutable MODULE_LIQUIDATION; // 청산 모듈
    /// @notice Address of the RiskManager module
    address public immutable MODULE_RISKMANAGER; // Riskmanage 모듈
    /// @notice Address of the BalanceForwarder module
    address public immutable MODULE_BALANCE_FORWARDER; // 잔액 전송 모듈
    /// @notice Address of the Governance module
    address public immutable MODULE_GOVERNANCE; // 거버넌스 관련 기능 모듈
